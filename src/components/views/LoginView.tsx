...
export const LoginView: React.FC = () => {
  ...
  return (
    <div className="min-h-screen w-full bg-[#080d1a] flex items-center justify-center p-4 sm:p-6 lg:p-8 font-sans text-slate-100 selection:bg-blue-600 selection:text-white">
      {/* Outer Card Shell */}
      <div className="w-full max-w-5xl bg-slate-900/90 border border-slate-800/90 rounded-3xl shadow-2xl overflow-hidden grid grid-cols-1 lg:grid-cols-12 min-h-[540px]">
