  ...
  static async getAll(): Promise<Department[]> {
    ...
    try {
      ...
      return (data || []).map((d: any) => ({
        ...
        teamsCount: d.teams_count || 1,
        membersCount: d.members_count || 4,
        activeProjectsCount: d.active_projects_count || 2,
        resourceAllocationPct: d.resource_allocation_pct || 80,
